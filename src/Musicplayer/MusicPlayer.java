...
public class MusicPlayer extends PlaybackListener {
    ...
    public MusicPlayer() {
        try {
            connection = DriverManager.getConnection("jdbc:mysql://localhost/musicplayer", "root", "password"); // Adjust connection string
    ...
    public String getPlaylistForUser(String username) {
        String query = "SELECT playlist FROM users WHERE username = ?";
    ...
    // Method to update the playlist of a user
    public void updatePlaylistForUser(String username, String playlist) {
        String query = "UPDATE users SET playlist = ? WHERE username = ?";
        try (PreparedStatement statement = connection.prepareStatement(query)) {
    ...
    public void loadPlaylist(ArrayList<String> playlistFile){
        playlist = new ArrayList<>();

        // store the paths from the text file into the playlist array list
        try{
            FileReader fileReader = new FileReader(String.valueOf(playlistFile));
